...
type Props = {
  ...
  // When true, the player box is the assignment target — clicking it commits the pending assignment.
...
export function PlayerBox({
  ...
  return (
    <button
      type="button"
      onClick={assignmentMode ? onAssignClick : undefined}
      ...
      aria-label={assignmentMode ? `Assign to ${faction.name}` : faction.name}
    >
